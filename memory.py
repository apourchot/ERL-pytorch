# from https://github.com/openai/baselines/blob/master/baselines/ddpg/memory.py
import numpy as np
...
class Memory(object):
    ...
    def sample(self, batch_size):
        ...
        obs0_batch = array_min2d(self.observations0.get_batch(batch_idxs))
        obs1_batch = array_min2d(self.observations1.get_batch(batch_idxs))
        action_batch = array_min2d(self.actions.get_batch(batch_idxs))
